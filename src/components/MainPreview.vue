<template>
  <div class="container-fluid">
    <div class="feedToggle myCheckbox left">
      <span id="betrToggle">Betradar</span>
      <input
        type="checkbox"
        id="someCheckboxID1"
        v-on:change="switchFeedPriority($event)"
        v-model="defaultFeed"
      />
      <label for="someCheckboxID1"></label>
      <span id="asiaToggle">Asia</span>
    </div>
    ...
    <div class="row sports">
      <div class="col-md-1 logo"><img src="../assets/images/logo.png" /></div>
      <div
        v-html="sport"
        v-bind:class="{
          'col-md-1': true,
      ...
      <div class="col-md-1 sportsList secondSportsList"></div>
      ...
      <div class="col-md-6 side" id="left">
        <div class="row filter">
          ...
          <div class="col-md-3">
            <input
              type="text"
              class="form-control team-search leaguePh"
          ...
          <div class="col-md-3">
            <select
              class="form-control sort team-search team-search-arrow"
        ...
        <div class="row basicOddsHeader">
          ...
          <div class="col-md-4">
            <div class="row">
              ...
              <div class="col-md-2 basicOddsGoals thumb">
                <img src="../assets/images/thumb-down-green.png" />
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              v-bind:style="[
                checkColor(
                  defaultFeed ? item.level_asian : item.level_betradar
                ),
              ]"
            >
              <div class="row">
                ...
                <div class="col-md-2 col-md-1-half alignRows">
                    ...
                    <div
                      v-bind:class="{
                        ...
                        pulse:
                          avoidNull(
                            defaultFeed
                              ? item.odds['KI 1']['asian_difference']
                              : item.odds['KI 1']['betradar_difference']
                          ) < 0,
                      }"
                      v-bind:style="[
                        avoidNull(
                  ...
                  <!-- <div class="row">
                    <div
                      class="col-md-6 betrTitle"
                    >
                      <span>BETR.</span>
                    </div>
                    <div
                      class="col-md-6 asiaTitle"
                    >
                      <span>ASIA</span>
                    </div>
                  </div> -->
                  <div class="row">
                    ...
                    >
                      <span
                        v-bind:class="{'danger-suggestion':
                          avoidNull(
                            defaultFeed
                              ? 1
                              : isMatchBad(item.odds)
                          ) < 0}"
                      >
                        {{
                          avoidNullAndConvertToFixed(
                            getOddForSelectedPayout(
                              item,
                              "KI 1",
                              "1x2",
                              "betradar"
                  ...
                  <div class="row">
                    ...
                    > <span v-bind:class="{
                      'danger-suggestion':
                          avoidNull(defaultFeed ? isMatchBad(item.odds) : 1) <
                          0
                    }">
                      {{
                        avoidNullAndConvertToFixed(
                          getOddForSelectedPayout(item, "KI 1", "1x2", "asia")
                        )
                      }}
                      </span>
                    </div>
                ...
                <div class="col-md-2 col-md-1-half alignRows">
                    ...
                    <div
                      v-bind:class="{
                        ...
                        pulse:
                          avoidNull(
                            defaultFeed
                              ? item.odds['KI X']['asian_difference']
                              : item.odds['KI X']['betradar_difference']
                          ) < 0,
                      }"
                      v-bind:style="[
                        avoidNull(
                  ...
                  <div class="row">
                    ...
                    <span v-bind:class="{
                      'danger-suggestion':
                          avoidNull(defaultFeed ? 1 : isMatchBad(item.odds)) <
                          0
                    }">
                      {{
                        avoidNullAndConvertToFixed(
                  ...
                  <div class="row">
                    ...
                    <span v-bind:class="{
                      ...
                      {{
                        avoidNullAndConvertToFixed(
                          getOddForSelectedPayout(item, "KI X", "1x2", "asia")
                        )
                      }}
                      </span>
                    </div>
                ...
                <div class="col-md-2 col-md-1-half alignRows">
                    ...
                    <div
                      v-bind:class="{
                        ...
                        pulse:
                          avoidNull(
                            defaultFeed
                              ? item.odds['KI 2']['asian_difference']
                              : item.odds['KI 2']['betradar_difference']
                          ) < 0,
                      }"
                      v-bind:style="[
                        avoidNull(
                  ...
                  <div class="row">
                    ...
                    <span v-bind:class="{
                      ...
                      {{
                        avoidNullAndConvertToFixed(
                          getOddForSelectedPayout(item, "KI 2", "1x2", "asia")
                        )
                      }}
                      </span>
                    </div>
                    ...
                    <div
                      v-bind:class="{
                        ...
                        pulse:
                          avoidNull(
                            defaultFeed
                              ? item.odds['UG 0-2']['asian_difference']
                              : item.odds['UG 0-2']['betradar_difference']
                          ) < 0,
                      }"
                      v-bind:style="[
                        avoidNull(
...
<span  v-bind:class="{
                    ...
                    <div
                      v-bind:class="{
                        ...
                        pulse:
                          avoidNull(
                            defaultFeed
                              ? item.odds['UG 3+']['asian_difference']
                              : item.odds['UG 3+']['betradar_difference']
                          ) < 0,
                      }"
                      v-bind:style="[
                        avoidNull(
                ...
                <div class="col-md-2 bela payoutGoals">
                  ...
                  <div class="row mtop25">
                    <div class="col-md-12">
                      {{ avoidNull(calculateObaranjePayout(item)) }}
                    </div>
                  </div>
                </div>
                <div class="col-md-2 plus">
                  ...
                  ></i>
                  <span class="badOdds badB">{{
                    avoidNull(item.num_outcomes_betradar)
                  }}</span
                  ><br />
                  <span class="badOdds badA">{{
                    avoidNull(item.num_outcomes_asian)
                  }}</span>
        ...
        <table class="table table-striped additionalOdds">
          ...
          <tr v-for="oddKey in oddsKeys" :key="oddKey" class="igre">
            ...
            <td>
              {{
                avoidNullAndConvertToFixed(
                  selectedMatch["odds"][oddKey]["asian"]
                )
              }}
            </td>
            <td
            ...
            <td
              v-bind:style="[
                avoidNull(selectedMatch['odds'][oddKey]['asian_difference']) < 0
                  ? { color: '#EC4949', fontWeight: 'bold' }
                  : { color: getColorAccordingToStyle() },
              ]"
            >
              {{
                avoidNullAndConvertToFixed(
                  selectedMatch["odds"][oddKey]["asian_difference"],
                  true,
                  true
                )
              }}
      ...
      <div class="col-md-6 side side-right" v-if="modes.loadingOdds">
        <p class="loadingOdds">Kvote se učitavaju</p>
         <img class="imgLoadingOdds" src="../assets/loader.gif" alt="Loader" width="50" />
      </div>
      <div class="col-md-6 side side-right" v-if="modes.nepovezani">
        ...
        <div class="row mec" v-for="item in data.hidden" :key="item.Code">
          ...
          <div
            class="col-md-8 teamNamesHolder"
            v-bind:style="[
              checkColor(defaultFeed ? item.level_asian : item.level_betradar),
            ]"
          >
            <div class="row">
              <div class="col-md-2 league-and-date">
              ...
              <div class="col-md-2 col-md-1-half alignRows">
                ...
                <div class="row">
                  ...
                  <span v-bind:class="{
                    'danger-suggestion':
                        avoidNull(defaultFeed ? 1 : isMatchBad(item.odds)) < 0,
                  }">
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "KI 1", "1x2", "betradar")
                      )
                    }}</span>
                  </div>
                </div>
                <div class="row">
                  ...
                  <span v-bind:class="{
                    'danger-suggestion':
                        avoidNull(defaultFeed ? isMatchBad(item.odds) : 1) < 0,
                  }">
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "KI 1", "1x2", "asia")
              ...
              <div class="col-md-2 col-md-1-half alignRows">
                ...
                <div class="row">
                  ...
                  <span v-bind:class="{
                    ...
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "KI X", "1x2", "betradar")
                      )
                    }}
                    </span>
                  </div>
              ...
              <div class="col-md-2 col-md-1-half alignRows">
                ...
                <div class="row">
                  ...
                  <span v-bind:class="{
                    ...
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "KI 2", "1x2", "betradar")
                      )
                    }}
                    </span>
                  </div>
              ...
              <div class="col-md-4 alignRows">
                ...
                <div class="row">
                  ...
                  <span v-bind:class="{
                    ...
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "UG 0-2", "goals", "asia")
                      )
                    }}</span>
                  </div>
                </div>
              ...
              <div class="col-md-4 alignRows">
                ...
                <div class="row">
                  ...
                  <span v-bind:class="{
                    ...
                    {{
                      avoidNullAndConvertToFixed(
                        getOddForSelectedPayout(item, "UG 3+", "goals", "asia")
                      )
                    }}
                    </span>
                  </div>
        ...
        >
          ...
          <div class="col-md-8 teamNamesHolder">
            <div class="row">
              <div class="col-md-2 league-and-date right-row">
                <b
                  >{{ new Date(item.startDate).getDate() }}.
              ...
              <div class="col-md-2 col-md-1-half alignRows nepRows">
                <div class="row">
              ...
              <div class="col-md-1 bela negmar desno">
          ...
          <div class="col-md-4">
            <div class="row basicOddsData">
              <div class="col-md-4 alignRows nepRows">
                <div class="row">
                  <div class="col-md-12 prod">
              ...
              <div class="col-md-4 bela payoutGoals desno nepGoals">
  ...
  <div class="modal-content">
    ...
    <div class="ro">
      <div class="col-md-12">
        <h2>Izmene:</h2>
    <ul class="help-list">
      <li>- Svi mečevi koji počinju danas do 23:59 imaju oznaku <strong style="color:yellow; background:black; padding:1px 5px 1px 5px">"Today"</strong> u koloni START.</li>
      <li>- Svi mečevi koji počinju od 00:00 do 09:00 imaju oznaku <strong style="color:lightgreen; background:black; padding:1px 5px 1px 5px">"Morning"</strong> u koloni START. </li>
      <li>- Filter za <strong>odabir lige</strong> funkcioniše tako da prilkom odabira jedne ili više liga, prikazuju se samo utakmice koje odgovaraju izabranom kriterijumu nezavisno od periodičnih izmena na 30 sekundi.</li>
      <li>- <strong>Pretraga mečeva</strong> se vrši nad svim mečevima i prikazuju se samo mečevi koji odgovaraju pretrazi nezavisno od periodičnih izmena na 30 sekundi. Pretraga se vrši po nazivima timova ili nazivu lige.</li>
      <li>- <strong>Vremenski filter</strong> po default-u prikazuje sve mečeve, odabirom neke od ostalih opcija prikazuju se samo mečevi koji odgovaraju izabranom kriterijumu nezavisno od periodičnih izmena na 30 sekundi.</li>
      <li>- <strong>Sortiranje</strong> se uvek vrši samo nad mečevima koji su trenuto prikazani na stranici. (svi ili redukovani nekim od filtera)</li>
      <li>- <strong>Sakriveni mečevi <span style='color:red'>(x)</span></strong> se svakako osvežavaju nevezano sa tim što su prebačeni u deo za manuelnu kontrolu.</li>
    </ul>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      defaultFeed:false, //betradar - false, asia - true
      data: {
        primary: [],
        secondary: [],
        hidden: [],
  ...
  methods: {
    isMatchBad(odds) {
      let outcomes = ["KI 1", "KI 2", "KI X", "UG 0-2", "UG 3+"];
      let l = outcomes.length;
      for (let i = 0; i < l; i++) {
        if (
          odds[outcomes[i]][
            this.defaultFeed ? "asian_difference" : "betradar_difference"
          ] < 0
        ) {
          return -1;
        }
    ...
    switchFeedPriority(e){
      let val = e.target.checked;
      this.defaultFeed = val;
    ...
    getOddForSelectedPayout(item, odd, type, source) {
      return type == "1x2"
        ? item.odds[odd].obaranje[source][item.closest1x2Payout]
        : item.odds[odd].obaranje[source][item.closestGoalsPayout]
    },
    ...
    transformNepovezani(all, source) {
      ...
      this.temp.nep = [];
      this.temp.ids = [];
      this.determineNepovezani();
      this.removeNepovezaniFromPrimary();
    ...
    determineNepovezani() {
      for (let i = 0; i < this.all.length; i++) {
        if (
          ...
          this.all[i]["odds"]["KI 1"]["asian"] == 0 &&
          this.all[i]["odds"]["KI X"]["asian"] == 0 &&
          this.all[i]["odds"]["KI 2"]["asian"] == 0
        ) {
          this.temp.nep.push({
      ...
      switch (val) {
        case "1":
          this.data.primary.sort(function (a, b) {
            return self.defaultFeed ? a.level_asian - b.level_asian : a.level_betradar - b.level_betradar;
          });
          break;
        case "2":
          this.data.primary.sort(function (a, b) {
        ...
        case "4":
          var losi = this.data.primary.filter(
            (x) =>
              x.odds["KI 1"][self.defaultFeed ? "asian_difference" : "betradar_difference"] < 0 ||
              x.odds["KI X"][self.defaultFeed ? "asian_difference" : "betradar_difference"] < 0 ||
              x.odds["KI 2"][self.defaultFeed ? "asian_difference" : "betradar_difference"] < 0 ||
              x.odds["UG 0-2"][self.defaultFeed ? "asian_difference" : "betradar_difference"] < 0 ||
              x.odds["UG 3+"][self.defaultFeed ? "asian_difference" : "betradar_difference"] < 0
          );
                var self = this;
    ...
    checkColor(betradar) {
      ...
      var level = betradar;
      if (level >= 0) return { borderLeft: "10px solid #4CB540" };
      if (level < 0 && level >= -0.1) {
        return { borderLeft: "10px solid #F9E458" };
      } else if (level < -0.1 && level >= -0.3) {
        return { borderLeft: "10px solid #F24242" };
      } else {
        return { borderLeft: "10px solid #870000" };
      }
    },
    calculateObaranjePayout(item) {
      let p1 = this.avoidNullAndConvertToFixed(
        this.getOddForSelectedPayout(item, "UG 0-2", "goals", this.defaultFeed ? 'asia' : 'betradar')
      );
      let p2 = this.avoidNullAndConvertToFixed(
        this.getOddForSelectedPayout(item, "UG 3+", "goals", this.defaultFeed ? 'asia' : 'betradar')
      );
    ...
    showMoreOdds(code) {
      ...
      if (this.currentCode != code && code != null) {
        ...
        //ovde
        let id = this.data.primary.filter((x) => x.Code == code)[0]['matchId'];
              this.modes.loadingOdds = true;
              this.modes.odds = false;
        this.socket.emit("razrada", id);
        //ovde
        
      } else {
        this.modes.loadingOdds = false;
        this.modes.odds = false;
    ...
    removeSeconds() {
      // setTimeout(() => {
      //       document.querySelectorAll(".item")[0].querySelectorAll("div")[1].innerText=""
      //     }, 1);
    },
    isDefaultPreview() {
      return (
  ...
  created() {
    ...
    socket.on("razrada", function(match){
      if(match){
      self.selectedMatch = match
      let odds = self.selectedMatch.odds;
        Object.keys(odds).forEach((el) => {
          if (el != "code" && el != "matchId" && el != "betradar_id")
            self.differenceArr.push({
              key: el,
              diff: self.defaultFeed ? (odds[el]["asian_difference"]
                ? odds[el]["asian_difference"]
                : null) :  (odds[el]["betradar_difference"]
                ? odds[el]["betradar_difference"]
                : null),
            });
        });
        self.differenceArr.sort(function (a, b) {
          return a.diff - b.diff;
        });

        self.oddsKeys = self.differenceArr.map((x) => x.key);
        self.originalOddKeys = _.cloneDeep(self.oddsKeys);
      self.modes.nepovezani = false;
      self.modes.odds = true;
      self.modes.loadingOdds = false;
      }
